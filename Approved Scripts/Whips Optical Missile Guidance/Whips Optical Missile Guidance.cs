...
{ 
    ...
    { 
        ...
        if (thisGyro != null) 
        { 
            thisGyro.SetValue(gyroRelativeYaw[i], (float)yaw_speed * gyroYawSign[i]); 
            thisGyro.SetValue(gyroRelativePitch[i], (float)pitch_speed * gyroPitchSign[i]); 
            thisGyro.SetValue(gyroRelativeRoll[i], (float)roll_speed * gyroRollSign[i]); 
            thisGyro.SetValue("Override", true); 
        } 
    } 
} 
